...
def helper(dis):
    ...
    # Convert medications from list to individual items
    med = medications[medications['Disease'] == dis]['Medication']
    med = [item.strip() for items in med.values for item in items.strip('[]').replace("'", "").split(',')]

    # Convert diets from list to individual items
    die = diets[diets['Disease'] == dis]['Diet']
    die = [item.strip() for items in die.values for item in items.strip('[]').replace("'", "").split(',')]
